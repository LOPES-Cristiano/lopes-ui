...
export default function ChatComposer({
  ...
  return (
    <div
      ...
      className={twMerge("flex flex-col bg-white border-t border-zinc-200", className)}
    >
      {/* Reply preview */}
      {replyTo && (
        <div className="flex items-start gap-2 px-3 pt-2.5 pb-1.5 border-b border-zinc-100">
          ...
          <button
            ...
            className="p-0.5 rounded-md hover:bg-zinc-100 text-zinc-400 hover:text-zinc-600 transition-colors"
      ...
      <div className="flex items-end gap-1.5 px-2.5 py-2.5">
          ...
          <div className="flex gap-0.5 shrink-0 pb-0.5">
            {onAttach && (
              <button
                onClick={onAttach}
                disabled={disabled}
                className="p-1.5 rounded-xl hover:bg-zinc-100 text-zinc-400 hover:text-zinc-600 transition-colors disabled:opacity-40"
        ...
        <textarea
          ...
          rows={1}
          className={twMerge(
            "flex-1 resize-none rounded-2xl border border-zinc-200 bg-zinc-50 px-3.5 py-2",
        ...
        <div className="shrink-0 pb-0.5">
          {canSend ? (
            ...
            <button
              onClick={onVoice}
              disabled={disabled}
              className="p-2 rounded-xl hover:bg-zinc-100 text-zinc-400 hover:text-zinc-600 transition-colors disabled:opacity-40"
