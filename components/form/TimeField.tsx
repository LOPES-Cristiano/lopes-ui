...
export type TimeFieldProps = Omit<FieldWrapperProps, "children" | "id"> & {
  id?: string;
  name?: string;
  /** "minutes" = HH:MM, "seconds" = HH:MM:SS */
  ...
  disabled?: boolean;
  readOnly?: boolean;
  /** Min time in HH:MM format */
  min?: string;
  /** Max time in HH:MM format */
  max?: string;
  size?: "sm" | "md" | "lg";
...
export default function TimeField({
  ...
  id: idProp, name, precision = "minutes",
