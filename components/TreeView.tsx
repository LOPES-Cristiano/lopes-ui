...
function TreeItem({ node }: { node: TreeNode }) {
  ...
  const childIndent = showLines
    ? (size === "sm" ? "border-l border-zinc-200 ml-[1.3125rem] pl-0.5" : "border-l border-zinc-200 ml-[1.5625rem] pl-0.5")
      ...
      <div
        ...
        className={[
          ...
          isDropTarget && dropPos === "inside"
            ? "ring-2 ring-inset ring-blue-400 bg-blue-50 text-zinc-700"
            : "",
        ].join(" ")}
